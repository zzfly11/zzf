...
>接下来进入联想的***Root***环节。实际上，对于联想来说，破解绝非难事，反而如何获取超级管理权限是大家一直苦思的问题，但有了 ***9008*** 这一利器，这一切都显得轻而易举，让我们开始吧！
...
>若命令窗口显示 ***你的序列号+device*** 则表示你已经成功连接电脑

>关闭该窗口，依次点击 ***线刷专区*** , ***EDL(9008)*** ，进入***9008***模式

>进入后，打开 ***QFIL***

>最上面一栏中，选择 ***Tools*** ， ***Partition Manager***，点击打开分区表，找到名为 ***boot*** 的分区

>右键该分区，选择第一个 ***Manage partition*** ，再点击第二个 ***Read Data...***
...
>此时手机安装并打开**Magisk_23.0**,首页点击第一个***安装***，下一步，在**方式**一栏里，选择**选择并修补一个文件**
